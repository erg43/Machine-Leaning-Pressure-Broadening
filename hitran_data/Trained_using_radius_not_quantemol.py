...
for key, data in db.items():
    if 'findair' in data.columns:
        ...
        molecules[key] = data[['nu', 'sw', 'a', 'gamma_air', 'J', 'Jpp', 'molecule_weight', 'air_weight', 'gamma_air-err', 'm', 'findair', 'broadness_jeanna']]
...
for molecule in molecule_list:
    ...
    data_train = data[0][['nu', 'sw', 'a', 'gamma_air', 'J', 'Jpp', 'molecule_weight', 'air_weight', 'gamma_air-err', 'm', 'findair', 'broadness_jeanna']]
    data_test = data[1][['nu', 'sw', 'a', 'gamma_air', 'J', 'Jpp', 'molecule_weight', 'air_weight', 'gamma_air-err', 'm', 'findair', 'broadness_jeanna']]
...
for molecule in molecule_list:
    ...
    data_test = data_test.sample(frac=1)
    data_train = data_train.sample(frac=1)
    X_train = data_train.drop(['gamma_air', 'gamma_air-err', 'broadness_jeanna'], axis=1)
    y_train = data_train['gamma_air']
    weight_train = data_train['gamma_air-err']
    X_test = data_test.drop(['gamma_air', 'gamma_air-err', 'broadness_jeanna'], axis=1)
    y_test = data_test['gamma_air']
    weight_test = data_test['gamma_air-err']
