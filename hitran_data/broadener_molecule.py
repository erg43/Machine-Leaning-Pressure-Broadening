...
#%%
table = pd.DataFrame(list(zip(total_lines, air_lines, air_prop, He_lines, He_prop, H2_lines, H2_prop, Co2_lines, Co2_prop, H2o_lines, H2o_prop, self_lines, self_prop)), index =keys,
                                              columns =['total_lines', 'air_lines', 'air_prop', 'He_lines', 'He_prop', 'H2_lines', 'H2_prop', 'Co2_lines', 'Co2_prop', 'H2o_lines', 'H2o_prop', 'self_lines', 'self_prop'])
#%%
print(table)
#%%
