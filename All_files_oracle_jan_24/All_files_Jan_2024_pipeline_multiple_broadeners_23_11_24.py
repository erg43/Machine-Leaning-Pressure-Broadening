...
for key, datas in db.items():
    ...
    if 'B0a' in datas.columns:
        ...
        #             'molecule_dipole', 'polar', 'B0a', 'B0b', 'B0c', 'air_weight', 'Ka_aprox',
        #             'Kapp_aprox', 'Kc_aprox', 'Kcpp_aprox', 'gamma_self', 'gamma_self-err', 
        #             'gamma_H2', 'gamma_H2-err', 'gamma_He', 'gamma_He-err', 'gamma_H2O',
        #             'gamma_H2O-err', 'gamma_CO2', 'gamma_CO2-err']]
        #, 'K', 'Ka', 'Kc']]
        #, 'symmetry', 'vee']]
        #'molecule_weight', 'Ka_aprox', 'Kapp_aprox', 'Kc_aprox', 'Kcpp_aprox']]
        #, 'nu', 'sw', 'a']]
        ...
        for broadener in broadeners:
            ...
            if key == 'CH3CN':
                broadness_jeanna = broadening(data['m'][20]+data['broadener_m'][2], T, data['molecule_weight'][20], data['broadener_weight'][2], data['d'][20]/2+data['broadener_d'][2]/2)
            else:
